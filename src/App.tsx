...
const IdeaValidator = lazy(() => import("./pages/entrepreneur/IdeaValidator"));
const FinancialSimulator = lazy(() => import("./pages/entrepreneur/FinancialSimulator"));
const LeanCanvasPage = lazy(() => import("./pages/entrepreneur/LeanCanvasPage"));
